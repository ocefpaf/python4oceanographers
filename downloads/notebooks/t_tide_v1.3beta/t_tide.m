...
%  [Pxr,fx]=pwelch(real(xres),hanning(nx),ceil(nx/2),nx,1/dt);
%  Pxr=Pxr/2/dt;
%  [Pxi,fx]=pwelch(imag(xres),hanning(nx),ceil(nx/2),nx,1/dt);
%  Pxi=Pxi/2/dt;
%  [Pxc,fx]=cpsd(real(xres),imag(xres),[],[],nx,1/dt);
%  Pxc=Pxc/2/dt;

[Pxr,fx]=pwelch(real(xres),hanning(nx),[],nx,1/dt);
Pxr=Pxr/2/dt;
[Pxi,fx]=pwelch(imag(xres),hanning(nx),[],nx,1/dt);
Pxi=Pxi/2/dt;
[Pxc,fx]=cpsd(real(xres),imag(xres),[],[],nx,1/dt);
Pxc=Pxc/2/dt;
